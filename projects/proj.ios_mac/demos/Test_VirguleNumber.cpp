...
static YHUIVirguleNumber * createNumber()
{
    ...
    number->setVirguleInterval(6.0f);
    return number;
}
...
//        this->addChild(testNumber);
        
        {
            ...
            number1->setPosition(center.x, center.y + center.y * 0.8f);
            ...
            number2->setPosition(center.x, center.y + center.y * 0.5f);
            ...
            number3->setPosition(center.x, center.y + center.y * 0.2f);
        ...
        
        {
            ...
            number1->setPosition(center.x, center.y - center.y * 0.8f);
            number1->getLNumberSprite()->setColor(Color3B(0xff, 0, 0));
            number1->setIconAndInterval(Sprite::createWithSpriteFrameName("Pic_UI_Coin.png"), 18);
            this->addChild(number1);
            ...
            number2->setAlignType(YHISpriteNumber::kAlignType_Center);
            number2->getRNumberSprite()->setColor(Color3B(0, 0, 0xff));
            number2->setIconAndInterval(Sprite::createWithSpriteFrameName("Pic_UI_Coin.png"), 18);
            this->addChild(number2);
            ...
            number3->setAlignType(YHISpriteNumber::kAlignType_Right);
            number3->setColor(Color3B(0xff, 0xff, 0));
            number3->setIconAndInterval(Sprite::createWithSpriteFrameName("Pic_UI_Coin.png"), 18);
            this->addChild(number3);
        }
