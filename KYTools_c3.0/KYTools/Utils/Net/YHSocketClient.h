...
#include <KYTools/Utils/Net/Utils/YHSocketConnectManager.h>
#include <KYTools/Utils/Net/Utils/YHSocketSendManager.h>
#include <KYTools/Utils/Net/Utils/YHSocketRecvManager.h>

/**
 * Socket 通信功能封装
 * @author Zhenyu Yao
 */
class YHSocketClient : public YHObject
{
...
public:
	...
	/**
	 * 接收数据, 已经经过拆包, 供游戏直接使用的数据. 调用者必须手动 release 掉返回的 YHByteArray 对象.
	 * @return 接收到的数据流
	 */
